            ...
            <v-row class="pt-4">
              <v-col cols="8" md="8" sm="12" class="pb-0">
                <v-text-field-with-validation
                  ...
                  :label="`${$t('eventSummary.registrationLocation.name')} *`"
                  :rules="rules.name"
              ...
              <v-col cols="12" class="pb-0">
                <validation-provider v-slot="{ errors, classes }" :rules="rules.streetAddress" mode="aggressive" data-test="location-streetAddress">
                  <rc-google-autocomplete
                    ...
                    :api-key="apiKey"
                    outlined
                    :placeholder="`${$t('common.address.streetAddress')} *`"
...
export default Vue.extend({
  ...
  computed: {
    ...
    title(): TranslateResult {
      if (this.isEditMode) {
        return this.$t('eventSummary.editRegistrationLocation');
      }
      return this.$t('eventSummary.addRegistrationLocation');
    },
    ...
    allLocations(): IEventGenericLocation[] {
      return this.isRegistrationLocation ? this.event.registrationLocations : [];
    },
  },
