...
describe('HouseholdMemberSection.vue', () => {
  let wrapper;
  beforeEach(async () => {
  ...
  describe('Template', () => {
    it('displays the first name and last name correctly', async () => {
      const title = wrapper.find('[data-test="householdMember__identity"]');
      expect(title.text()).toBe(`${mockPerson().firstName} ${mockPerson().lastName}`);
    });

    describe('Edit button', () => {
      it('is shown if inline mode is false', async () => {
        const editButton = wrapper.find('[data-test="inlineEdit__householdMember__open"]');
    ...
    describe('Delete button', () => {
      it('is shown if inline mode is false', async () => {
        const deleteButton = wrapper.find('[data-test="inlineEdit__householdMember__delete"]');
  ...
  describe('Methods', () => {
    describe('edit', () => {
      it('should be called when clicking the edit button', async () => {
        ...
        const button = wrapper.find('[data-test="inlineEdit__householdMember__open"]');
    ...
    describe('onDelete', () => {
      ...
      it('should be called when clicking the delete button', async () => {
        ...
        const button = wrapper.find('[data-test="inlineEdit__householdMember__delete"]');
        await button.trigger('click');
