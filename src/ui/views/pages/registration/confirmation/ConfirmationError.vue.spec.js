    ...
    describe('isDuplicateError', () => {
      ...
      it('returns true if the error is a duplicate of a kind', async () => {
        await wrapper.setProps({
          errors: [
            mockHttpError({ code: 'errors.the-beneficiary-have-duplicate-first-name-last-name-birthdate' }),
          ],
        });
      ...
      it('returns true if the error is a duplicate of a kind', async () => {
        await wrapper.setProps({
          errors: [
            mockHttpError({ code: 'errors.the-beneficiary-have-duplicate-first-name-last-name-phone-number' }),
          ],
        });
        expect(wrapper.vm.isDuplicateError).toEqual(true);
      });
      ...
      it('returns true if the error is a duplicate of a kind', async () => {
        await wrapper.setProps({
          errors: [
            mockHttpError({ code: 'errors.the-household-have-duplicate-first-name-last-name-birthdate' }),
          ],
        });
        expect(wrapper.vm.isDuplicateError).toEqual(true);
      });
