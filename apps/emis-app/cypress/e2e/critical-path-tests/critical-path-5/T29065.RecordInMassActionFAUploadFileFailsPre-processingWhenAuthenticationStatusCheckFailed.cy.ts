...
describe('[T29065] Mass Action FA upload file fails pre-processing when Authentication status check failed', { tags: ['@financial-assistance', '@mass-actions'] }, () => {
  before(() => {
      ...
      describe(`${roleName}`, () => {
        ...
        it('should successfully upload file but fail to preprocessing a file', function () {
          cannotPreProcessFaMassActionSteps({
            ...
            filePath: 'cypress/downloads/TC1505FaFile.csv',
