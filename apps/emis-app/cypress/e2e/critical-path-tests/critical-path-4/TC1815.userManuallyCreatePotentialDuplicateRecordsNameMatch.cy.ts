      ...
      describe(`${roleName}`, () => {
        beforeEach(() => {
          cy.then(async function () {
            ...
            cy.wrap(resultComparisonHousehold.mockCreateHousehold.primaryBeneficiary.identitySet).as('comparisonHouseholdPrimaryBeneficiary');
        ...
        it('should manually create potential duplicate records based on name match', function () {
          ...
          cy.contains('Flag a new household as a potential duplicate with '
            + `${this.comparisonHouseholdPrimaryBeneficiary.firstName} ${this.comparisonHouseholdPrimaryBeneficiary.lastName}`)
            .should('be.visible');
          manageDuplicatesPage.getFlagNewHouseholdRegistrationNumberField(this.originalHouseholdRegistrationNumber);
          manageDuplicatesPage.provideFlagNewDuplicateRationale('This is a potential duplicate');
          manageDuplicatesPage.getDuplicatedByField('Full Name');
