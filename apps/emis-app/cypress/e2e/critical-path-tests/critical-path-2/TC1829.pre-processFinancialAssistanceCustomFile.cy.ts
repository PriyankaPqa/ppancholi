...
import { fixtureBaseMassAction, fixtureGenerateCustomFinancialAssistanceFile, fixtureNewMassFinancialAssistance } from '../../../fixtures/mass-actions';
    ...
    for (const [roleName, roleValue] of Object.entries(canRoles)) {
      describe(`${roleName}`, () => {
        ...
        it('should successfully pre-process a financial assistance custom file', function () {
          fixtureGenerateCustomFinancialAssistanceFile([this.caseFile1, this.caseFile2, this.caseFile3], this.faTable.id, filePath);
          ...
          newMassFinancialAssistancePage.uploadCSVFile().selectFile(filePath, { force: true });
