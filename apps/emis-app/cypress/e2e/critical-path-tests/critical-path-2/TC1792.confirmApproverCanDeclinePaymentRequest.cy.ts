    ...
    for (const [roleName, roleValue] of Object.entries(canRoles)) {
      describe(`${roleName}`, () => {
        ...
        it('should successfully decline a payment request by approver', function () {
          ...
          approvalsPage.getLabelConfirmedDecline().contains('I confirm that I have informed the requestor that the approval has been declined.').should('be.visible');
          approvalsPage.checkConfirmedDecline();
