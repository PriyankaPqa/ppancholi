...
describe('#TC302# - Submit a Invoice Payment', { tags: ['@financial-assistance'] }, () => {
  before(() => {
      ...
      describe(`${roleName}`, () => {
        beforeEach(() => {
          cy.then(async function () {
            ...
            const financialAssistancePayment = await addFinancialAssistancePayment(resultPrepareStateHousehold.provider, EPaymentModalities.Invoice, resultPrepareStateHousehold.registrationResponse.caseFile.id, this.table.id);
