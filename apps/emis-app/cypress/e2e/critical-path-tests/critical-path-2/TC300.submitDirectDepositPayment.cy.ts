...
describe('#TC300# - Submit a Direct Deposit Payment', { tags: ['@financial-assistance'] }, () => {
  before(() => {
      ...
      describe(`${roleName}`, () => {
        beforeEach(() => {
          cy.then(async function () {
            ...
            const financialAssistancePayment = await addFinancialAssistancePayment(resultPrepareStateHousehold.provider, EPaymentModalities.DirectDeposit, resultPrepareStateHousehold.registrationResponse.caseFile.id, this.table.id);
