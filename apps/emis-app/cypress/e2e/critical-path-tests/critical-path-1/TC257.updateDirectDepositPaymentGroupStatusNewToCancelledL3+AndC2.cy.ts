      ...
      describe(`${roleName}`, () => {
        beforeEach(() => {
          cy.then(async function () {
            ...
            const resultPrepareStateHouseholdFAPayment = await prepareStateHouseholdAddSubmitUpdateFAPayment(accessTokenL6, this.event, this.table.id, PaymentStatus.New, EPaymentModalities.DirectDeposit);
