...
import { createProgramWithTableWithItemAndSubItem, createEventAndTeam, prepareStateHousehold } from 'cypress/e2e/helpers/prepareState';
import { removeTeamMembersFromTeam } from 'cypress/e2e/helpers/teams';
import { AddFinancialAssistancePage } from 'cypress/pages/financial-assistance-payment/addFinancialAssistance.page';
import { fixtureGiftCardPaymentLine } from 'cypress/fixtures/case-management';
    ...
    for (const [roleName, roleValue] of Object.entries(canRoles)) {
      describe(`${roleName}`, () => {
        ...
        it('should successfully create Gift Card Payment Line', function () {
          const paymentLineData = fixtureGiftCardPaymentLine();
          ...
          addFinancialAssistancePage.fillDescription(`Financial Description Gift Card Payment Line - retries - ${this.test.retries.length}`);
          ...
          addFinancialAssistancePage.getPaymentLineGroupTitle().should('eq', 'Gift card');
