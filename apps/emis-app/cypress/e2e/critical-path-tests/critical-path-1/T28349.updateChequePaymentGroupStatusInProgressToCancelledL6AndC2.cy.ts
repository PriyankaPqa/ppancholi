...
describe('[T28349] Update Cheque payment group status from In Progress to Cancelled- L6 and C2', { tags: ['@financial-assistance'] }, () => {
  before(() => {
  ...
  describe('Can Roles', () => {
    for (const roleName of filteredCanRoles) {
      describe(`${roleName}`, () => {
        ...
        it('should successfully update Cheque payment group status from In Progress to Cancelled', function () {
