  ...
  describe('Methods', () => {
    describe('updateTime', () => {
      ...
      it('updates the data correctly with the correct new date if the slot has a date', async () => {
        ...
        expect(wrapper.vm.scheduleCopy).toEqual({
          0: { day: 0, timeSlots: [] },
          1: { day: 1, date: '2024-01-02', timeSlots: [{ start: '09:00', end: '15:00', endDate: new Date('2024-01-02 15:00').toISOString() }] },
          2: { day: 2, timeSlots: [] },
          3: { day: 3, timeSlots: [] },
          4: { day: 4, timeSlots: [] },
          5: { day: 5, timeSlots: [] },
        ...
        expect(wrapper.vm.scheduleCopy).toEqual({
          ...
          1: { day: 1,
            ...
            timeSlots: [{ start: '09:00:00', end: '12:00:00' }, { start: '12:00:00',
              ...
              startDate: new Date('2024-01-02 12:00').toISOString(),
              endDate: new Date('2024-01-02 17:00').toISOString(),
            }] },
          2: { day: 2, timeSlots: [] },
          3: { day: 3, timeSlots: [] },
          4: { day: 4, timeSlots: [] },
        ...
        expect(wrapper.vm.scheduleCopy).toEqual({
          ...
          2: { day: 2,
            ...
            timeSlots: [{ start: '09:00:00',
              ...
              startDate: new Date('2024-01-02 09:00').toISOString(),
              endDate: new Date('2024-01-02 17:00').toISOString(),
            }] },
          3: { day: 3, timeSlots: [] },
          4: { day: 4, timeSlots: [] },
