  ...
  methods: {
    async onSubmit() {
      ...
      if (isValid) {
        this.loading = true;
        const params = {
          receivingAssistance: this.isReceivingAssistanceChangeTo,
          rationale: this.rationale,
        } as ReceivingAssistanceDetail;
        const res = await useCaseFileIndividualStore().addReceiveAssistanceDetails(this.caseFileId, this.caseFileIndividualId, params);
        if (res) {
