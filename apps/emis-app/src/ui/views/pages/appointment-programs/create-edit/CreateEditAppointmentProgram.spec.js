  ...
  describe('Methods', () => {
    ...
    describe('onStatusChange', () => {
      it('changes the appointment program status when in not edit mode', () => {
        mountWrapper(false);
        validateCanSetActiveStatus.mockImplementation(() => true);
      ...
      it('does not call the endpoint if validateCanSetActiveStatus returns false and shows the right message', async () => {
        jest.clearAllMocks();
        await mountWrapper();
        validateCanSetActiveStatus.mockImplementation(() => false);
