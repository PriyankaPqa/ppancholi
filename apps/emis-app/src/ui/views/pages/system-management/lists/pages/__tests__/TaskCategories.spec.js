...
import Component from '../TaskCategories.vue';
...
describe('TaskCategories.vue', () => {
  ...
  describe('Template', () => {
    ...
    it('uses correct title', () => {
      expect(wrapper.findComponent(OptionList).props('title')).toBe('system_management.lists.taskCategories');
    });
  });
  ...
  describe('Created hook', () => {
    ...
    it('set the list with correct one', () => {
      expect(optionListStore.list).toEqual(EOptionLists.TaskCategories);
    });
  });
});
