...
import Component from '../ExceptionalAuthenticationTypes.vue';
...
describe('ExceptionalAuthenticationTypes.vue', () => {
  let wrapper;
  ...
  describe('Template', () => {
    ...
    it('uses correct title', () => {
      expect(wrapper.findComponent(OptionList).props('title')).toBe('system_management.lists.exceptionalAuthenticationTypes');
    });
  });
  ...
  describe('Created hook', () => {
    ...
    it('set the list with correct one', () => {
      expect(optionListStore.list).toEqual(EOptionLists.ExceptionalAuthenticationTypes);
    });
  });
});
