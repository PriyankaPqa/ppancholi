...
import Component from '../CaseNoteCategories.vue';
import OptionList from '../../components/OptionList.vue';

const localVue = createLocalVue();
const storage = mockStorage();

describe('CaseNoteCategories.vue', () => {
  let wrapper;
  ...
  describe('Template', () => {
    ...
    it('uses correct title', () => {
      expect(wrapper.findComponent(OptionList).props('title')).toBe('system_management.lists.caseNoteCategories');
    });
  });
  ...
  describe('Created hook', () => {
    ...
    it('set the list with correct one', () => {
      expect(storage.optionList.mutations.setList).toHaveBeenCalledWith(EOptionLists.CaseNoteCategories);
    });
  });
});
