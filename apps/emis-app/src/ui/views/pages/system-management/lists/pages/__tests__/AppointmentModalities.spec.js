...
import Component from '../AppointmentModalities.vue';
...
describe('AppointmentModalities.vue', () => {
  let wrapper;
  ...
  describe('Template', () => {
    ...
    it('uses correct title', () => {
      expect(wrapper.findComponent(OptionList).props('title')).toBe('system_management.lists.appointmentModalities');
    });
  });
  ...
  describe('Created hook', () => {
    ...
    it('set the list with correct one', async () => {
      ...
      expect(optionListStore.list).toEqual(EOptionLists.AppointmentModalities);
    });
  });
});
