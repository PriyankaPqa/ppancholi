...
import Component from './CommunicationHomeMassAction.vue';

const localVue = createLocalVue();

describe('CommunicationHomeMassAction.vue', () => {
  let wrapper;
  ...
  describe('Data', () => {
    ...
    it('should have proper detailsRouteName', () => {
      expect(wrapper.vm.detailsRouteNameData).toEqual(routes.massActions.communications.details.name);
    });
