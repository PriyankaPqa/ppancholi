<template>
  <rc-dialog
    :title="$t('massAction.authenticationRetry.table.add.list')"
    :show.sync="show"
    ...
    <rc-data-table
      ...
      data-test="massAction_authentication_retry_caseFile_table"
      @search="search">
      <template #filter>
        <filter-toolbar
          :filter-key="FilterKey.MassActionAuthenticationRetry"
          :count="itemsCount"
          ...
          <template #toolbarActions>
            <v-btn
              ...
              @click="onExport(MassActionType.AuthenticationRetry)">
...
export default mixins(massActionCaseFileFiltering).extend({
  name: 'AuthenticationRetryCaseFileFiltering',
