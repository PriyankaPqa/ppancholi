...
import { MassActionMode, mockMassActionEntity } from '@/entities/mass-action';
  ...
  describe('Template', () => {
    ...
    describe('MassActionBaseCreate', () => {
      ...
      it('should be linked the correct props url', () => {
        expect(wrapper.findComponent(MassActionBaseCreate).props('uploadUrl')).toBe('case-file/mass-actions/import-payment-status');
      });
  ...
  describe('Methods', () => {
    ...
    describe('back', () => {
      it('should redirect to home page', () => {
        wrapper.vm.back();
        expect(wrapper.vm.$router.replace).toHaveBeenLastCalledWith({ name: routes.massActions.importPaymentStatus.home.name });
      });
    });
    ...
    describe('goToDetail', () => {
      it('should redirect to detail page', () => {
        ...
        expect(wrapper.vm.$router.push).toHaveBeenLastCalledWith(
          { name: routes.massActions.importPaymentStatus.details.name, params: { id: '1' } },
        );
      });
    });
