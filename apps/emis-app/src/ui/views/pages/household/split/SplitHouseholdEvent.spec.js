...
import { EEventStatus, mockEventEntityData, mockEventMainInfo } from '@libs/entities-lib/event';
  ...
  describe('Methods', () => {
    ...
    describe('fetchActiveEvents', () => {
      ...
      it('maps the response into events', async () => {
        ...
        expect(wrapper.vm.events).toEqual(events.map((e) => new RegistrationEvent(e.entity)));
      });
    });
