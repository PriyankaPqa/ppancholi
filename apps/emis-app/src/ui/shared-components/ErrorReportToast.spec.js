...
describe('ErrorReportToast', () => {
  ...
  const errorWAFFormat = {
    ...
    config: {
      ...
      baseURL: 'https://api-lab2.crc-tech.ca/',
      withCredentials: true,
      method: 'patch',
      url: 'https://api-lab2.crc-tech.ca/case-file/case-files/e6112152-be92-4d45-8b9a-69320dc7a835/labels',
  ...
  describe('Computed', () => {
    describe('api', () => {
      it('returns the right value', async () => {
        ...
        expect(wrapper.vm.api).toEqual('https://api-lab2.crc-tech.ca/case-file/case-files/e6112152-be92-4d45-8b9a-69320dc7a835/labels');
      });
    });
