...
export class ApprovalTableEntityModule extends BaseModule <IApprovalTableEntity, uuid> {
  ...
  public getModule = () => ({
    ...
    actions: this.actions as unknown as ActionTree<IState<IApprovalTableEntity>, IRootState>,
  })
