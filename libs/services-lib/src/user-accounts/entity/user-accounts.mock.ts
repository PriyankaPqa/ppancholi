import { mockUserAccountEntities, mockUserAccountEntity, mockUserAccountMetadata, mockUserProfileQueryResponses } from '@libs/entities-lib/user-account';
...
export const mockUserAccountsService = (): IUserAccountsServiceMock => ({
  ...
  searchDirectoryUsers: jest.fn(() => mockUserProfileQueryResponses()),
});
