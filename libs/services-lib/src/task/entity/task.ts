import { ITaskEntity, ITaskEntityData } from '@libs/entities-lib/task';
import { ITaskService } from './task.types';
import { IHttpClient } from '../../http-client';
import { DomainBaseService } from '../../base';

const API_URL_SUFFIX = 'task';
const CONTROLLER = 'tasks';

export class TaskService extends DomainBaseService<ITaskEntity, uuid> implements ITaskService {
  ...
  async createTask(task: ITaskEntityData): Promise<ITaskEntityData> {
    ...
    return this.http.post('/case-file/tasks', parseTask, { globalHandler: false });
  }
