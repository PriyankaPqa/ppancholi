...
export class surveyData {
  ...
  static panelDynamicTranslatedFrenchEnglishDefault = JSON.stringify({
    logo: {
     default: 'https://api-dev2.crc-tech.ca/system-management/tenant-settings/c400f50d-7a56-4ef2-8e44-211bfa434724/logo/en',
     fr: 'https://api-dev2.crc-tech.ca/system-management/tenant-settings/c400f50d-7a56-4ef2-8e44-211bfa434724/logo/fr',
    },
    logoPosition: 'right',
    pages: [
     {
  ...
  static matrixDropdownQuestion = JSON.stringify({
    logo: {
      default: 'https://api-lab2.crc-tech.ca/system-management/tenant-settings/c400f50d-7a56-4ef2-8e44-211bfa434724/logo/en',
      fr: 'https://api-lab2.crc-tech.ca/system-management/tenant-settings/c400f50d-7a56-4ef2-8e44-211bfa434724/logo/fr',
    },
    logoPosition: 'right',
    pages: [
      {
